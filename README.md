...
- **Git Tools: Remove from Git Index** ensures the selected tracked file or folder has an entry in the nearest `.gitignore`, then runs `git rm --cached` and keeps the local content.
